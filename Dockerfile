...
RUN python -m pip install --no-cache-dir --default-timeout=120 --retries=5 pyyaml flask flask-socketio playwright==1.57.0 docker openai anthropic google-generativeai
