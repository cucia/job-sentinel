...
class WorkflowHandler(ABC):
    ...
    def analyze_page_and_plan(
        ...
        return {
            ...
            "page_analysis": analysis,
            "execution_plan": plan,
            "ready_for_execution": plan.confidence_score > 0.5,
        }
...
class IndeedHandler(WorkflowHandler):
    ...
    def prepare_for_processing(self, task: Task) -> dict:
        ...
        return {
            ...
            "confidence": task.workflow_confidence,
            "session": session,
            "next_step": "analyze_indeed_page",
            "requires": ["indeed_session", "resume"],
        }
...
class NaukriHandler(WorkflowHandler):
    ...
    def prepare_for_processing(self, task: Task) -> dict:
        ...
        return {
            ...
            "confidence": task.workflow_confidence,
            "session": session,
            "next_step": "analyze_naukri_page",
            "requires": ["naukri_session", "resume"],
        }
